...
gulp.task("scss", function () {
  return gulp
    .src([paths.src.scss + "/pixel/**/*.scss", paths.src.scss + "/pixel.scss"])
    .pipe(wait(500))
...
gulp.task(
  ...
  gulp.series("scss", "html", "index", "assets", "vendor", function () {
    ...
    gulp.watch(
      [paths.src.scss + "/pixel/**/*.scss", paths.src.scss + "/pixel.scss"],
      gulp.series("scss")
    );
    gulp.watch(
